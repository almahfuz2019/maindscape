...
const Deshboard = () => {
  ...
  <div className="drawer-side">
    ...
    <ul className="menu p-4 w-60 bg-gray-900 text-base-content">
      ...
      <li className='text-white bg-gray-500 mt-2'><NavLink to="waiting-blogs"> <AiOutlineAppstore className='text-xl'/> Waiting Blogs</NavLink></li>
      <li className='text-white bg-gray-500 mt-2'><NavLink to="categorys"> <AiOutlineAppstore className='text-xl'/> Categorys</NavLink></li>
      <li className='text-white bg-gray-500 mt-2'><NavLink to="users"> <AiOutlineAppstore className='text-xl'/> Users</NavLink></li>
      <li className='text-white bg-gray-500 mt-2'><NavLink to="contactinfo"> <AiOutlineAppstore className='text-xl'/> Messages</NavLink></li>
    </ul>
